...
scoreboard players set @s[gamemode=adventure,scores={timer=102..,class=1}] timer 0
scoreboard players set @s[gamemode=adventure,scores={timer=76..,class=2}] timer 0
scoreboard players set @s[gamemode=adventure,scores={timer=80..,class=3}] timer 0

execute as @s[gamemode=adventure,scores={timer=1..7,class=4,Y=..57},distance=..100,x=620,y=20,z=620] at @s run tp @p ~ ~2 ~

scoreboard players set @s[gamemode=adventure,scores={timer=155..,class=4}] timer 0
...
execute unless entity @e[scores={mode=1}] run scoreboard players set @s[gamemode=adventure,scores={timer=160..,class=7}] timer 0
...
scoreboard players set @s[gamemode=adventure,scores={timer=45..,class=8}] timer 0

scoreboard players set @s[gamemode=adventure,scores={timer=75..,class=10}] timer 0
